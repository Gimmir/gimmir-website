  ...
  return (
    <section className="relative z-20 py-16 sm:py-24 px-4 sm:px-6 border-t border-white/5">
      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        <div className="absolute -bottom-24 left-1/2 -translate-x-1/2 h-24 w-px bg-gradient-to-b from-[#333] via-[#0062d1] to-[#0062d1] z-30"></div>
      </div>
    </section>
  );
}
