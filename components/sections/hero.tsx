...
export function HeroSection() {
  return (
    <section className="relative z-10 min-h-[100vh] flex flex-col items-center justify-start pt-28 sm:pt-32 md:pt-40 px-4 text-center max-w-5xl mx-auto w-full">
      ...
      <h1 className="text-4xl sm:text-5xl md:text-7xl font-bold tracking-tight text-white mb-8 sm:mb-12 leading-snug drop-shadow-2xl animate-fade-in-up opacity-0" style={{ animationDelay: '0.2s', animationFillMode: 'forwards' }}>
      ...
      <p className="text-base sm:text-lg md:text-xl text-slate-400 max-w-2xl mb-10 sm:mb-12 font-light leading-relaxed mx-auto px-2 animate-fade-in-up opacity-0" style={{ animationDelay: '0.3s', animationFillMode: 'forwards' }}>
      ...
      <div className="flex flex-wrap justify-center gap-x-6 gap-y-4 md:gap-12 mb-16 sm:mb-20 px-2 animate-fade-in-up opacity-0" style={{ animationDelay: '0.5s', animationFillMode: 'forwards' }}>
         <div className="flex items-center gap-2 text-slate-400"><ShieldCheck className="text-[#0062d1]" size={16} /><span className="text-[10px] sm:text-xs font-medium uppercase tracking-wider">GDPR & HIPAA</span></div>
         <div className="flex items-center gap-2 text-slate-400"><FileKey className="text-[#0062d1]" size={16} /><span className="text-[10px] sm:text-xs font-medium uppercase tracking-wider">100% IP Transfer</span></div>
         <div className="flex items-center gap-2 text-slate-400"><Globe className="text-[#0062d1]" size={16} /><span className="text-[10px] sm:text-xs font-medium uppercase tracking-wider">US & EU Entity</span></div>
      </div>
