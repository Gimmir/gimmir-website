...
import type { TermsOfService } from '@/sanity/sanity-utils';
...
export default function TermsOfServiceClient({ terms, formattedDate }: TermsOfServiceClientProps) {
      ...
      <section className="relative pt-32 pb-20 px-6 border-b border-white/5 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 leading-tight animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
            {terms.title || 'Terms of Service & IP Agreement'}
          </h1>
          ...
          <p className="text-lg md:text-xl text-slate-400 max-w-3xl font-light leading-relaxed mb-8 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
            {terms.heroDescription || 'Governing your use of Gimmir services, including payment terms, obligations, and the clear transfer of Intellectual Property rights.'}
          </p>
              ...
              <div className="mt-8 pt-6 border-t border-white/5">
                <div className="flex items-center gap-3 opacity-60">
                    ...
                    <div>
                        ...
                        <div className="text-xs text-slate-400 font-bold">{terms.jurisdiction || 'Delaware, USA / EU'}</div>
                    </div>
                </div>
              </div>
            </div>
          ...
          <div className="lg:col-span-9 space-y-20">
            ...
            <section id="acceptance" className="scroll-mt-32">
              ...
              <div className="prose prose-invert prose-lg max-w-none text-slate-400">
                {terms.acceptanceBody ? (
                  <PortableText value={terms.acceptanceBody} components={portableTextComponents} />
                ) : (
                  <>
                    <p>
            ...
            <section id="intellectual-property" className="scroll-mt-32">
              ...
              <div className="space-y-6">
                    ...
                    <div className="flex items-start gap-4 relative z-10">
                        ...
                        <div>
                            ...
                            <div className="text-slate-400 text-sm leading-relaxed mb-4">
                              {terms.ipOwnershipBody ? (
                                <PortableText value={terms.ipOwnershipBody} components={portableTextComponents} />
                              ) : (
                                <p>
                                  Upon full payment of all fees associated with a project milestone, <strong className="text-white">you (the Client) retain 100% ownership</strong> of all custom source code, documentation, designs, and intellectual property created by Gimmir for that project.
                                </p>
                              )}
                            </div>
                            <ul className="text-xs text-slate-500 font-mono space-y-1">
                                {(terms.ipOwnershipChecklist || ['Source Code Transfer', 'IP Rights Assignment', 'No Hidden Licensing Fees']).map((item, idx) => (
                ...
                <div className="bg-[#0B0F19] p-6 rounded-xl border border-white/5">
                    ...
                    <div className="text-slate-400 text-sm leading-relaxed mb-4">
                      {terms.ipThirdPartyBody ? (
                        <PortableText value={terms.ipThirdPartyBody} components={portableTextComponents} />
                      ) : (
                        <p>
                    ...
                    <div className="flex gap-4 items-start p-4 bg-amber-900/10 border border-amber-500/20 rounded-lg">
                        ...
                        <p className="text-xs text-amber-200/80 leading-relaxed">
                            {terms.ipThirdPartyWarning || 'Client Responsibility: You are responsible for complying with the licenses of any specific third-party or open-source software you explicitly request us to integrate into the project.'}
                        </p>
                    </div>
                </div>
            ...
            <section id="payment" className="scroll-mt-32">
              ...
              <div className="bg-[#0B0F19] border border-white/10 rounded-xl p-6 mb-6">
                 ...
                 <div className="text-slate-400 text-sm">
                   {terms.paymentBody ? (
                     <PortableText value={terms.paymentBody} components={portableTextComponents} />
                   ) : (
                     <>
                       <p className="mb-4">
                       ...
                       <ul className="list-disc list-inside space-y-2 marker:text-[#0062d1]">
              ...
              <p className="text-slate-400 text-sm">
                {terms.paymentRefundText || 'Refunds: Due to the nature of custom engineering services, refunds are not provided for work already completed and approved. If you are unsatisfied with a deliverable, you must notify us within the review period (typically 5 business days) for rectification.'}
              </p>
            </section>
            ...
            <section id="termination" className="scroll-mt-32">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                 <div>
                    ...
                    <div className="text-slate-400 text-sm leading-relaxed">
                      {terms.terminationBody ? (
                        <PortableText value={terms.terminationBody} components={portableTextComponents} />
                      ) : (
                        <p>
                          Either party may terminate the service agreement with <strong className="text-white">30 days written notice</strong>. Upon termination, the Client shall pay for all work completed up to the termination date, and Gimmir shall transfer all work-in-progress code to the Client.
                        </p>
                      )}
                    </div>
                 </div>
                 <div>
                    ...
                    <div className="text-slate-400 text-sm leading-relaxed">
                      {terms.governingLawBody ? (
                        <PortableText value={terms.governingLawBody} components={portableTextComponents} />
                      ) : (
                        <p>
                          Any disputes arising out of or related to these Terms shall be governed by the laws of the <strong className="text-white">State of Delaware, USA</strong>, for US clients, or the laws of <strong className="text-white">Estonia</strong> for international/EU clients, without regard to conflict of laws rules.
                        </p>
                      )}
                    </div>
                 </div>
            ...
            <section id="acceptable-use" className="scroll-mt-32">
              ...
              <p className="text-slate-400 mb-4">
                {terms.acceptableUseIntro || "You agree not to use Gimmir's services or the resulting software for:"}
              </p>
              <ul className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                {(terms.acceptableUseList || [
            ...
            <section id="liability" className="scroll-mt-32 pb-12">
              ...
              <div className="bg-[#0B0F19] p-6 rounded-xl border border-white/5 text-slate-400 text-sm leading-relaxed">
                {terms.liabilityBody ? (
                  <PortableText value={terms.liabilityBody} components={portableTextComponents} />
                ) : (
                  <>
                    <p className="mb-4">
