...
export default function MVPDevelopmentPage() {
  return (
    <div className="min-h-screen bg-[#020408] text-white selection:bg-[#0062d1] selection:text-white overflow-x-hidden">
      ...
      <section className="relative z-10 min-h-screen flex flex-col items-center justify-center pt-32 md:pt-48 pb-20 px-4 text-center max-w-6xl mx-auto w-full">
        
        {/* Badge */}
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 backdrop-blur-md mb-10 animate-fade-in-up hover:bg-white/10 transition-colors cursor-default">
        ...
        {/* Headline */}
        <h1 className="text-5xl sm:text-7xl md:text-8xl font-bold tracking-tight text-white mb-8 leading-[1.1] drop-shadow-2xl">
        ...
        {/* Subheadline */}
        <p className="text-lg sm:text-xl md:text-2xl text-slate-400 max-w-3xl mb-12 font-light leading-relaxed mx-auto px-2">
          We build MVPs that act like mature products. Scalable architecture from Day 1, so you don't have to rebuild when you grow.
        </p>

        {/* CTA Buttons */}
        <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6 w-full justify-center mb-20 px-4">
          <button className="w-full sm:w-auto px-10 py-5 bg-[#0062d1] hover:bg-[#0052b3] text-white font-bold text-lg rounded-full shadow-[0_0_40px_-10px_rgba(0,98,209,0.5)] transition-all transform hover:scale-105 active:scale-95 flex items-center justify-center gap-3 group">
          ...
          <button className="w-full sm:w-auto px-10 py-5 bg-white/5 hover:bg-white/10 border border-white/10 text-white font-medium text-lg rounded-full transition-all active:scale-95 flex items-center justify-center gap-3 group backdrop-blur-sm">
        ...
        <div className="grid grid-cols-3 gap-8 sm:gap-16 border-t border-white/10 pt-10 w-full max-w-4xl">
          <div className="text-center group">
            <div className="text-3xl sm:text-4xl font-bold text-white mb-2 group-hover:text-[#0062d1] transition-colors">10 Weeks</div>
            <div className="text-xs text-slate-500 uppercase tracking-wider font-mono">Avg. Launch Time</div>
          </div>
          <div className="text-center group">
            <div className="text-3xl sm:text-4xl font-bold text-white mb-2 group-hover:text-emerald-500 transition-colors">100%</div>
            <div className="text-xs text-slate-500 uppercase tracking-wider font-mono">Success Rate</div>
          </div>
          <div className="text-center group">
            <div className="text-3xl sm:text-4xl font-bold text-white mb-2 group-hover:text-purple-500 transition-colors">0%</div>
            <div className="text-xs text-slate-500 uppercase tracking-wider font-mono">Equity Taken</div>
          </div>
        </div>
      </section>

      {/* 2. The "Founder's Nightmare" - Split View Redesign */}
      <section className="relative py-32 px-6 border-t border-white/5 bg-[#050810]">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            <h2 className="text-3xl md:text-5xl font-bold text-white mb-6">The Rewrite Trap</h2>
            <p className="text-slate-400 text-lg max-w-2xl mx-auto">Most MVPs are built to be thrown away. We build assets that appreciate in value.</p>
          </div>
          
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-0 rounded-3xl overflow-hidden border border-white/10">
            {/* The Trap */}
            <div className="relative p-10 sm:p-16 bg-[#0B0F19] border-b lg:border-b-0 lg:border-r border-white/10 group">
              <div className="absolute top-0 right-0 p-8 opacity-5 group-hover:opacity-10 transition-opacity">
                <XCircle size={200} className="text-red-500" />
              </div>
              <div className="relative z-10">
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded bg-red-500/10 text-red-400 text-xs font-bold uppercase mb-8 border border-red-500/20">
                  The "Cheap" MVP
                </div>
                <h3 className="text-3xl font-bold text-white mb-6">The $20k Dead End</h3>
                ...
                <ul className="space-y-4">
                  <li className="flex items-center gap-4 text-slate-400">
                    ...
                    <span>Requires complete rewrite to scale</span>
                  </li>
                  <li className="flex items-center gap-4 text-slate-400">
                    <div className="w-6 h-6 rounded-full bg-red-500/10 flex items-center justify-center shrink-0 border border-red-500/20">
                      <XCircle size={14} className="text-red-500" />
                    </div>
                    <span>No documentation for Due Diligence</span>
                  </li>
                  <li className="flex items-center gap-4 text-slate-400">
                    <div className="w-6 h-6 rounded-full bg-red-500/10 flex items-center justify-center shrink-0 border border-red-500/20">
                      <XCircle size={14} className="text-red-500" />
                    </div>
                    <span>Vendor lock-in (you don't own the code)</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            {/* The Gimmir Asset */}
            <div className="relative p-10 sm:p-16 bg-[#050A14] group">
              <div className="absolute inset-0 bg-[radial-gradient(#0062d1_1px,transparent_1px)] [background-size:20px_20px] opacity-10"></div>
              <div className="absolute top-0 right-0 p-8 opacity-5 group-hover:opacity-10 transition-opacity">
                <CheckCircle2 size={200} className="text-[#0062d1]" />
              </div>
              <div className="relative z-10">
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded bg-[#0062d1]/10 text-[#0062d1] text-xs font-bold uppercase mb-8 border border-[#0062d1]/20">
                  The Gimmir Standard
                </div>
                <h3 className="text-3xl font-bold text-white mb-6">The Scalable Foundation</h3>
                <p className="text-slate-400 mb-10 leading-relaxed text-lg">
                ...
                <ul className="space-y-4">
                  <li className="flex items-center gap-4 text-white">
                    <div className="w-6 h-6 rounded-full bg-[#0062d1]/20 flex items-center justify-center shrink-0 border border-[#0062d1]/50">
                      <CheckCircle2 size={14} className="text-[#0062d1]" />
                    </div>
                    <span>Scales to Series A and beyond</span>
                  </li>
                  <li className="flex items-center gap-4 text-white">
                    <div className="w-6 h-6 rounded-full bg-[#0062d1]/20 flex items-center justify-center shrink-0 border border-[#0062d1]/50">
                      <CheckCircle2 size={14} className="text-[#0062d1]" />
                    </div>
                    <span>Full Technical Due Diligence Pack</span>
                  </li>
                  <li className="flex items-center gap-4 text-white">
                    <div className="w-6 h-6 rounded-full bg-[#0062d1]/20 flex items-center justify-center shrink-0 border border-[#0062d1]/50">
                      <CheckCircle2 size={14} className="text-[#0062d1]" />
      ...
      <section className="py-32 px-6 border-t border-white/5">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[minmax(250px,auto)]">
            {/* Card 1 - Large */}
            <div className="md:col-span-2 bg-[#0B0F19] p-10 rounded-3xl border border-white/5 hover:border-[#0062d1]/30 transition-all group relative overflow-hidden">
              <div className="absolute top-0 right-0 w-64 h-64 bg-[#0062d1]/5 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2"></div>
              <div className="relative z-10">
                <div className="w-14 h-14 bg-[#0062d1]/10 rounded-2xl flex items-center justify-center mb-8 group-hover:scale-110 transition-transform duration-500">
                  <FileCheck className="text-[#0062d1]" size={28} />
                </div>
                <h3 className="text-2xl font-bold text-white mb-4">IP Ownership Certificate</h3>
            ...
            {/* Card 2 */}
            <div className="bg-[#0B0F19] p-10 rounded-3xl border border-white/5 hover:border-[#0062d1]/30 transition-all group relative overflow-hidden">
              <div className="w-14 h-14 bg-emerald-500/10 rounded-2xl flex items-center justify-center mb-8 group-hover:scale-110 transition-transform duration-500">
            ...
            <div className="bg-[#0B0F19] p-10 rounded-3xl border border-white/5 hover:border-[#0062d1]/30 transition-all group relative overflow-hidden">
              ...
              <h3 className="text-2xl font-bold text-white mb-4">Transparent Roadmap</h3>
              <p className="text-slate-400 leading-relaxed">
            ...
            <div className="md:col-span-2 bg-[#0B0F19] p-10 rounded-3xl border border-white/5 hover:border-[#0062d1]/30 transition-all group relative overflow-hidden">
               ...
               <div className="relative z-10 flex flex-col md:flex-row items-center gap-8">
                  <div className="flex-1">
                    ...
                    <h3 className="text-2xl font-bold text-white mb-4">Enterprise Security Standard</h3>
      ...
      <section className="py-32 px-6 border-t border-white/5 bg-[#050810]">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            <h2 className="text-3xl md:text-5xl font-bold text-white mb-6">From Concept to Launch</h2>
            <p className="text-slate-400 text-lg">No jargon. Just results.</p>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
              {[
                ...
                <div key={i} className="relative group">
                  <div className="w-24 h-24 bg-[#0B0F19] border border-white/10 rounded-full flex items-center justify-center text-2xl font-bold text-slate-700 group-hover:text-[#0062d1] group-hover:border-[#0062d1] transition-all duration-300 mb-8 relative z-10 mx-auto md:mx-0 shadow-xl">
                    {phase.step}
                  </div>
                  <div className="text-center md:text-left">
                    <div className="inline-block px-3 py-1 rounded bg-white/5 border border-white/10 text-xs font-mono text-slate-400 mb-4">
                      {phase.weeks}
                    </div>
      ...
      <section className="py-32 px-6 border-t border-white/5">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="p-8 bg-[#0B0F19] rounded-2xl border border-white/5 hover:border-[#0062d1]/30 transition-all group">
              <div className="flex items-center justify-between mb-8">
                <Globe2 size={32} className="text-[#0062d1]" />
                <span className="text-xs font-mono text-slate-500 border border-white/10 px-2 py-1 rounded">FRONTEND</span>
              </div>
              <h3 className="text-2xl font-bold text-white mb-2">React / Next.js</h3>
            ...
            <div className="p-8 bg-[#0B0F19] rounded-2xl border border-white/5 hover:border-yellow-500/30 transition-all group">
              <div className="flex items-center justify-between mb-8">
                <Server size={32} className="text-yellow-500" />
                <span className="text-xs font-mono text-slate-500 border border-white/10 px-2 py-1 rounded">BACKEND</span>
              </div>
              <h3 className="text-2xl font-bold text-white mb-2">Python / Node</h3>
            ...
            <div className="p-8 bg-[#0B0F19] rounded-2xl border border-white/5 hover:border-purple-500/30 transition-all group">
              <div className="flex items-center justify-between mb-8">
                <Smartphone size={32} className="text-purple-500" />
                <span className="text-xs font-mono text-slate-500 border border-white/10 px-2 py-1 rounded">MOBILE</span>
              </div>
              <h3 className="text-2xl font-bold text-white mb-2">Swift / Kotlin</h3>
      ...
      <section className="py-32 px-6 border-t border-white/5 bg-[#050810]">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-3xl font-bold text-white mb-12 text-center">Common Founder Questions</h2>
          <div className="space-y-6">
            {[
              ...
              <div key={i} className="bg-[#0B0F19] p-8 rounded-2xl border border-white/5 hover:border-white/10 transition-colors">
      ...
      <section className="relative py-40 px-6 overflow-hidden border-t border-white/5 bg-[#050A14]">
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
            <button className="w-full sm:w-auto px-12 py-6 bg-[#0062d1] hover:bg-[#0052b3] text-white font-bold text-xl rounded-xl transition-all shadow-[0_0_30px_-5px_rgba(0,98,209,0.4)] flex items-center justify-center gap-3 group hover:scale-105">
