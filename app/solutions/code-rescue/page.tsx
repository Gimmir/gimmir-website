...
import { AlertTriangle, Download, Activity, Server, Database, Cpu, ShieldAlert, CheckCircle2, ArrowRight } from 'lucide-react';

export default function CodeRescuePage() {
  return (
    <div className="bg-[#020408] min-h-screen selection:bg-[#0062d1] selection:text-white">
      <HeroSection />
      {/* Наступні секції будуть додані сюди */}
    </div>
  );
}
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center relative z-10">
        ...
        <div className="text-center lg:text-left">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-[1.1] tracking-tight animate-fade-in-up opacity-0 drop-shadow-2xl" style={{ animationDelay: '0.1s', animationFillMode: 'forwards' }}>
            Turn Your <span className="text-white whitespace-nowrap">Technical Debt</span> <br className="hidden lg:block" />
